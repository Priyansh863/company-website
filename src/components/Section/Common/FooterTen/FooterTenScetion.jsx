            ...
            <div class="row">
              ...
              <div class="col-xl-2 col-lg-2 col-md-4">
                <div class="tekup-footer-menu">
                  ...
                  <ul>
                    <li>
                      <Link href="about-usl">About Us</Link>
                    </li>
                    <li>
                      <Link href="teaml">Our Team</Link>
                    </li>
                    {/* <li>
                      <Link href="pricingl">Pricing</Link>
                    </li>
                    <li>
                      <Link href="blogl">Blogs</Link>
                    </li> */}
                    <li>
                      <Link href="contact-usl">Contact Us</Link>
                    </li>
                  </ul>
                </div>
              </div>
